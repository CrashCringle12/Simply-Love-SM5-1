...
local PlayerDefaults = {
    __index = {
        initialize = function(self)
            ...
            self.HighScores = {EnteringName = false, Name = ""}
            self.Stages = {Stats = {}}
            self.PlayerOptionsString = nil
            self.ITLData = {["pathMap"] = {}, ["hashMap"] = {}}
...
local GlobalDefaults = {
    __index = {
        ...
        initialize = function(self)
            ...
            self.ContinuesRemaining =
                ThemePrefs.Get("NumberOfContinuesAllowed") or 0
...
SL = {
    ...
    DecorativeColors = {
        "#FF3C23", "#FF003C", "#C1006F", "#8200A1", "#413AD0", "#0073FF",
        "#00ADC0", "#5CE087", "#AEFA44", "#FFFF00", "#FFBE00", "#FF7D00"
    },
    ...
    Preferences = {
        ...
        ITG = {
            ...
            MinTNSToHideNotes = "TapNoteScore_W3",
            MinTNSToScoreNotes = ThemePrefs.Get("RescoreEarlyHits") and
                "TapNoteScore_W3" or "TapNoteScore_None",
            HarshHotLifePenalty = true,
        ...
        ["FA+"] = {
            ...
            MinTNSToScoreNotes = ThemePrefs.Get("RescoreEarlyHits") and
                "TapNoteScore_W4" or "TapNoteScore_None",
            HarshHotLifePenalty = true,

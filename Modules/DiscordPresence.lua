...
function updateDiscordGameplayStatus(pn)
    ...
    local detail = string.format(
        "%s %s %s ...",
        player_data.failed == true and "💀Failed - " or "Playing",
        song_info.mode,
        ToExtraShortString(song_info.style, step_data:GetDifficulty(), song_info.difficulty)
    );

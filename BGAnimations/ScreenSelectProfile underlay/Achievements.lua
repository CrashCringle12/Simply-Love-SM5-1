			...
			SetCommand=function(self, params)
				if params == nil then
					...
					if accolades[params.packIndex][params.achievementIndex] then
						self:settext(accolades[params.packIndex][params.achievementIndex].Name)
					else
						self:settext("N/A")
					end
				end
		...
		LoadFont("Common Normal")..{
			...
			SetCommand=function(self, params)
				...
				--	SM(params)
					...
					if accolades[params.packIndex][params.achievementIndex] then
						self:settext(accolades[params.packIndex][params.achievementIndex].Desc)
					else
						self:settext("N/A")
					end
				end
			...
			SetCommand=function(self, params)
				if params == nil then
					...
					if accolades[params.packIndex][params.achievementIndex] then
						...
						for i=1,accolades[params.packIndex][params.achievementIndex].Difficulty do
							str = str .. "⭐"
						end
						self:settext(str)
					else
